...
$GLOBALS['TL_LANG']['tl_content']['mejs_youtube'] = array('YouTube ID', 'Please enter the YouTube Video ID. You can find it in a regular YouTube URL as parameter v=xxx');
